...
log_file = r'work_dirs\bevfusion_lidar_voxel0075_second_secfpn_8xb4-cyclic-20e_nus-3d\20251208_195132\20251208_195132.log'
output_loss_file = 'training_loss_30e.png'
output_map_file = 'validation_map_30e.png'
...
# Epoch val line to associate with map (optional, but good for x-axis)
# But mAP usually printed after loop. formatting: "Epoch(val) [30][81/81] ... mAP: 0.3923"
# The line containing mAP also contains "Epoch(val) [XX]" usually? 
# In the log snippet viewed: "2025/12/09 12:25:59 ... Epoch(val) [30][81/81] ... mAP: 0.3923"
# So we can capture the epoch from the same line.
...
if losses:
    ...
    plt.ylabel('Loss')
    plt.title('Training Loss (30 Epochs)')
    plt.grid(True)
    plt.legend()
